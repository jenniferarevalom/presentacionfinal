...
@app.route('/')
def main_page():
	return 'Bienvenido clasificacion de opinion abogados usando CNN!'

@app.route('/AWS_SOM/', methods=['GET','POST'])
def rayosx():
	return 'clasificacion de opinion abogados!'

@app.route('/AWS_SOM/', methods=['GET','POST'])
def default():
    #print (request.args)
    test_image_path = './dataset/test.csv'
    opentest = pd.read_csv('dataset/test.csv',usecols=['Edificio','P1a','P2','P3','P4','P5a','P5b','P5c','P5d','P6','P7','P8','P9','P10a','P10b','P10c','P10d','P11','P12','P13','P14','P15','P16'])
